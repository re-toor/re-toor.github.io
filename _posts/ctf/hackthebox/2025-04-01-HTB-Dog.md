...
![intro](/assets/img/2025-04-01-HTB-Dog/Dog.webp)
...
![one](/assets/img/2025-04-01-HTB-Dog/1.webp)
...
![two](/assets/img/2025-04-01-HTB-Dog/2.webp)
...
![three](/assets/img/2025-04-01-HTB-Dog/3.webp)
...
function bee_browser_load_html() {
  ...
  $browser_output .= "<img src='./images/bee.webp' align='right' width='150' height='157' style='max-width:100%;margin-top:3rem;'>";
  // Add meaningful text.
...
![six](/assets/img/2025-04-01-HTB-Dog/6.webp)

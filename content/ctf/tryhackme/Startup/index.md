...
Hôm nay tôi sẽ giải CTF [Tryhackme - Startup](https://tryhackme.com/room/startup). Géc gô!!!

Vẫn như thông thường thôi, việc đầu tiên cần làm là quét cổng. 

![scan-port](scan-port.png?stayle=centerme)
...
![port21](port21.png?stayle=centerme)
...
![notice](notice.png?stayle=centerme)
...
![incidents](incidents.png?stayle=centerme)
...
![lennie-password](lennie-pass.png?stayle=centerme)

Đăng nhập và tôi có user flag.

![user-flag](user-flag.png?stayle=centerme)
...
![reverse-shell](reverse-shell.png?stayle=centerme)

![rooted](rooted.png?stayle=centerme)

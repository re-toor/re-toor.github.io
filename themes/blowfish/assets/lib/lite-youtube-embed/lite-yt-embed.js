...
class LiteYTEmbed extends HTMLElement {
     ...
     * Interestingly this sddefault png is often smaller in filesize, but we will still attempt it second
    ...
    upgradePosterImage() {
        ...
        setTimeout(() => {
            const pngUrl = `https://i.ytimg.com/vi_png/${this.videoId}/sddefault.png`;
            const img = new Image();
            ...
            img.onload = e => {
                ...
                this.style.backgroundImage = `url("${pngUrl}")`;
            }
        }, 100);
    }
}
